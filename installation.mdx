---
title: "Install WyvernJS via npm, CDN Script Tags, or ES Modules"
sidebarTitle: "Installation"
description: "Add WyvernJS to your project using npm, ES module imports from jsDelivr, or classic script tags. No build step or bundler required."
---
...
<Tabs>
  ...
  <Tab title="CDN Script Tags">
    ...
    <script src="https://cdn.jsdelivr.net/npm/@mchen_dragon/wyvernjs@latest/main/firewyvern.js"></script>
  ...
  <Tab title="ES Module Imports">
    ...
    import { fw, firewyrm }     from 'https://cdn.jsdelivr.net/npm/@mchen_dragon/wyvernjs@latest/main/firewyvern.js';
