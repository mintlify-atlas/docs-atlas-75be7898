---
title: "WeakMap-Backed DOM Event Handling with DiWu Methods"
sidebarTitle: "Events"
description: "DiWu adds .on(), .off(), .once(), and .promiseMeOnce() to EventTarget — a WeakMap registry prevents duplicate listeners and enables wildcard removal."
---
