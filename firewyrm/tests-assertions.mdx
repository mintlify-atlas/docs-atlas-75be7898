---
title: "FireWyrm Tests and Assertions: Complete API Reference"
sidebarTitle: "Tests & Assertions"
description: "Complete reference for FireWyrm's test methods — fw.start(), fw.test(), fw.assert(), fw.end() — and all 40 chainable matchers with examples."
---
