...
description: "Learn what WyvernJS is, why it exists, its four modules, and how to choose which ones to use in your project."
---
...
| **ShuiHu** (Water Tiger) | `sh` | ES9+ (`logToDOM` is browser-only) | Structured logging with log levels, in-memory history, step-based benchmarking, and DOM log output |
...
| **ShuiHu** | ✅ Full support (including `logToDOM` / `outputElementLogs`) | ✅ Core logging and benchmarking work; `logToDOM` and DOM output methods are browser-only |
